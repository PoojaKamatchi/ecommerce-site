...
export default function Home() {
  ...
  // ✅ Fetch popular products (Customer)
  useEffect(() => {
            ...
            {categories.map((cat) => {
              ...
              return (
                ...
                >
                  ...
                  />
                  <h3 className="font-semibold text-lg">{nameEn}</h3>
                  {nameTa && (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
              {popularProducts.map((product, index) => (
                ...
                >
                  ...
                  {product.name?.ta && <p className="text-sm text-gray-500">{product.name.ta}</p>}
