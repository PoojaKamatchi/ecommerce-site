          ...
          return (
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-gray-800">
                {typeof p.name === "object" ? p.name.en || p.name.ta || "Unnamed Product" : p.name || "Unnamed Product"}
              </h3>
              ...
              <div className="flex gap-3 mt-5">
                {isInCart ? (
                  <button disabled className="flex-1 py-2 rounded-lg bg-gray-300 text-gray-700 cursor-not-allowed font-medium">
                    ✅ Added to Cart
                  </button>
                ) : (
                  <button
                ...
                {isInWishlist ? (
                  <button disabled className="flex-1 bg-gray-300 text-gray-700 rounded-lg py-2 cursor-not-allowed font-medium">
                    ❤️ In Wishlist
                  </button>
                ) : (
                  <button
